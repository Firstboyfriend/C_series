...
function addMapLeft() {
    ...
    var html=' <div id="ImgTypeBox">\
                    <div>\
                         <input id="cb_station" type="checkbox" style="vertical-align: middle;" /><span style="vertical-align: middle; color: White;"><label for="cb_station">站点　&nbsp;<img style="width: 20px; height: 20px;" align="absmiddle" src="/C3/PC/MRTA/css/img/station.png"></label></span>\
                    </div>\
<div>\
...
function LoadLoca(options) {
    ...
    if (json != undefined) {
        for (var i = 0; i < json.length; i++) {
            ...
            var icon = "机车_s.png";
            if (json[i].TRAIN_NO.split('CRH').length > 1) {
                icon = "动车_s.png";
            }
