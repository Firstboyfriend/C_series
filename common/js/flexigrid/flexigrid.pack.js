...
(function ($) {
    ...
    $.addFlex = function (t, p) {
        ...
        p = $.extend({
            ...
            onChangeSort: true, // 当改变排序时，可在此方法中重写默认实现，自行实现客户端排序
        ...
        var g = {
            ...
            addData: function (data) { // parse data
                ...
                if (p.total == 0) {
                    ...
                    //by wcg  这里主要是为了使onSuccess在即便flexigrid初始化调用获得的数据为空时仍然会执行
        ...
        if (p.usepager) {
            ...
            if (p.useRp) {
                ...
                $('.pDiv2', g.pDiv).prepend("<div class='pGroup'><select name='rp'  style='width:100px;'>"
